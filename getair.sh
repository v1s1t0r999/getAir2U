...
#General vars
getAir2U_version="1.0.0"
language_strings_expected_version="1.0.0-1"
...
rc_file_name=".getAir2Urc"
alternative_rc_file_name="getAir2Urc"
...
github_user="v1s1t0r999"
github_repository="getAir2U"
branch="master"
script_filename="getair.sh"
...
#Tmux vars
session_name="getAir2U"
tmux_main_window="getAir2U-Main"
no_hardcore_exit=0
...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["ENGLISH"]="getAir2U will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="getAir2U intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="getAir2Uv va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="getAir2U intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O getAir2U tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="getAir2U попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το getAir2U θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="getAir2U cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="getAir2U spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="getAir2U wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="getAir2U çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول getAir2U تنزيل ملف سلاسل اللغة ..."
	...
	language_strings_first_time["ENGLISH"]="If you are seeing this message after an automatic update, don't be scared! It's probably because getAir2U has different file structure since version 6.1. It will be automatically fixed"
	language_strings_first_time["SPANISH"]="Si estás viendo este mensaje tras una actualización automática, ¡no te asustes! probablemente es porque a partir de la versión 6.1 la estructura de ficheros de getAir2U ha cambiado. Se reparará automáticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message après une mise à jour automatique ne vous inquiétez pas! A partir de la version 6.1 la structure de fichier d'getAir2U a changé. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si estàs veient aquest missatge després d'una actualització automàtica, no t'espantis! probablement és perquè a partir de la versió 6.1 l'estructura de fitxers de getAir2U ha canviat. Es repararà automàticament"
	language_strings_first_time["PORTUGUESE"]="Se você está vendo esta mensagem depois de uma atualização automática, não tenha medo! A partir da versão 6.1 da estrutura de arquivos do getAir2U mudou. Isso será corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="Если вы видите это сообщение после автоматического обновления, не переживайте! Вероятно, это объясняется тем, что, начиная с версии 6.1, getAir2U имеет другую структуру файлов. Проблема будет разрешена автоматически"
	language_strings_first_time["GREEK"]="Εάν βλέπετε αυτό το μήνυμα μετά από κάποια αυτόματη ενημέρωση, μην τρομάξετε! Πιθανόν είναι λόγω της διαφορετικής δομής του getAir2U μετά από την έκδοση 6.1. Θα επιδιορθωθεί αυτόματα"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente è perché a partire dalla versione 6.1 é cambiata la struttura dei file di getAir2U. Sarà riparato automaticamente"
	language_strings_first_time["POLISH"]="Jeśli widzisz tę wiadomość po automatycznej aktualizacji, nie obawiaj się! To prawdopodobnie dlatego, że w wersji 6.1 zmieniła się struktura plików getAir2U. Naprawi się automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von getAir2U geändert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren getAir2U dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="إذا كنت ترى هذه الرسالة بعد التحديث التلقائي ، فلا تخف! ربما يرجع السبب في ذلك إلى أن getAir2U له بنية ملفات مختلفة منذ الإصدار 6.1. سيتم إصلاحه تلقائيًا "

	declare -gA language_strings_exiting
	language_strings_exiting["ENGLISH"]="Exiting getAir2U script v${getAir2U_version} - See you soon! :)"
	language_strings_exiting["SPANISH"]="Saliendo de getAir2U script v${getAir2U_version} - Nos vemos pronto! :)"
	language_strings_exiting["FRENCH"]="Fermeture du script getAir2U v${getAir2U_version} - A bientôt! :)"
	language_strings_exiting["CATALAN"]="Sortint de getAir2U script v${getAir2U_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script getAir2U v${getAir2U_version} - Até breve! :)"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта getAir2U v${getAir2U_version} - До встречи! :)"
	language_strings_exiting["GREEK"]="Κλείσιμο του getAir2U v${getAir2U_version} - Αντίο :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script getAir2U v${getAir2U_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyjście z skryptu getAir2U v${getAir2U_version} - Do zobaczenia wkrótce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen getAir2U v${getAir2U_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="getAir2U yazılımından çıkış yapılıyor v${getAir2U_version} - Yakında görüşürüz! :)"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج getAir2U v${getAir2U_version}- نراكم قريبًا! :)"
...
function option_toggle() {
	...
	case "${option_var_name}" in
		"getAir2U_BASIC_COLORS")
			remap_colors
		;;
		"getAir2U_EXTENDED_COLORS")
			initialize_extended_colorized_output
		;;
		"getAir2U_5GHZ_ENABLED")
...
function debug_print() {
	...
	if "${getAir2U_DEBUG_MODE:-true}"; then
...
function special_text_missed_optional_tool() {
	...
	if ! "${getAir2U_DEVELOPMENT_MODE:-false}"; then
...
function get_5ghz_band_info_from_phy_interface() {
	...
	if iw phy "${1}" info 2> /dev/null | grep "5200 MHz" > /dev/null; then
		if "${getAir2U_5GHZ_ENABLED:-true}"; then
			return 0
		else
			return 2
		fi
	...
	case ${option_selected} in
		...
		2)
			if "${getAir2U_AUTO_UPDATE:-true}"; then
				ask_yesno 457 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_AUTO_UPDATE"; then
						echo
		...
		3)
			if "${getAir2U_SKIP_INTRO:-true}"; then
				ask_yesno 569 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_SKIP_INTRO"; then
						echo
		...
		4)
			if "${getAir2U_BASIC_COLORS:-true}"; then
				ask_yesno 558 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_BASIC_COLORS"; then
						echo
		...
		5)
			...
			if "${getAir2U_EXTENDED_COLORS:-true}"; then
				ask_yesno 462 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_EXTENDED_COLORS"; then
						echo
		...
		6)
			if "${getAir2U_AUTO_CHANGE_LANGUAGE:-true}"; then
				ask_yesno 469 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_AUTO_CHANGE_LANGUAGE"; then
						echo
		...
		7)
			if "${getAir2U_SILENT_CHECKS:-true}"; then
				ask_yesno 577 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_SILENT_CHECKS"; then
						echo
		...
		8)
			if "${getAir2U_PRINT_HINTS:-true}"; then
				ask_yesno 586 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_PRINT_HINTS"; then
						echo
		...
		9)
			if "${getAir2U_5GHZ_ENABLED:-true}"; then
				ask_yesno 596 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "getAir2U_5GHZ_ENABLED"; then
						echo
		...
		10)
			if [ "${getAir2U_WINDOWS_HANDLING}" = "xterm" ]; then
				ask_yesno 657 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(getAir2U_WINDOWS_HANDLING)=(xterm):\1=tmux:" "${rc_path}" 2> /dev/null
					echo
				...
				ask_yesno 658 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(getAir2U_WINDOWS_HANDLING)=(tmux):\1=xterm:" "${rc_path}" 2> /dev/null
					echo
					language_strings "${language}" 620 "yellow"
					language_strings "${language}" 115 "read"
				fi
		...
		12)
			...
			if [ "${yesno}" = "y" ]; then
				if option_toggle "getAir2U_PLUGINS_ENABLED" "required_reboot"; then
					echo
					language_strings "${language}" 620 "yellow"
				else
					echo
			...
			if [ "${yesno}" = "y" ]; then
				...
				if [ "${language}" = "${current_permanent_language}" ]; then
					...
					if "${getAir2U_AUTO_CHANGE_LANGUAGE:-true}"; then
						...
						option_toggle "getAir2U_AUTO_CHANGE_LANGUAGE"
					fi
...
function handshake_capture_check() {
	...
	if [ "${getAir2U_WINDOWS_HANDLING}" = "tmux" ]; then
...
function set_wep_key_script() {
	...
	cat >&8 <<-EOF
		#!/usr/bin/env bash
		getAir2U_WINDOWS_HANDLING="${getAir2U_WINDOWS_HANDLING}"
	EOF
	...
	cat >&8 <<-EOF
		...
		function manage_output() {
			...
			case "\${getAir2U_WINDOWS_HANDLING}" in
				"tmux")
					local tmux_color
					tmux_color=""
...
function mdk_version_toggle() {
	...
	if [ "${getAir2U_MDK_VERSION}" = "mdk3" ]; then
		sed -ri "s:(getAir2U_MDK_VERSION)=(mdk3):\1=mdk4:" "${rc_path}" 2> /dev/null
		getAir2U_MDK_VERSION="mdk4"
	else
		sed -ri "s:(getAir2U_MDK_VERSION)=(mdk4):\1=mdk3:" "${rc_path}" 2> /dev/null
		getAir2U_MDK_VERSION="mdk3"
	fi
...
function print_options() {
	...
	if [ "${getAir2U_WINDOWS_HANDLING}" = "xterm" ]; then
		if grep -q "getAir2U_WINDOWS_HANDLING=tmux" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 618 "blue"
	else
		if grep -q "getAir2U_WINDOWS_HANDLING=xterm" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
	...
	reboot_required_text=""
	if "${getAir2U_PLUGINS_ENABLED:-true}"; then
		if grep -q "getAir2U_PLUGINS_ENABLED=false" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 653 "blue"
	else
		if grep -q "getAir2U_PLUGINS_ENABLED=true" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
...
function clean_env_vars() {
	...
	unset getAir2U_AUTO_UPDATE getAir2U_SKIP_INTRO getAir2U_BASIC_COLORS getAir2U_EXTENDED_COLORS getAir2U_AUTO_CHANGE_LANGUAGE getAir2U_SILENT_CHECKS getAir2U_PRINT_HINTS getAir2U_5GHZ_ENABLED getAir2U_FORCE_IPTABLES getAir2U_MDK_VERSION getAir2U_PLUGINS_ENABLED getAir2U_DEVELOPMENT_MODE getAir2U_DEBUG_MODE getAir2U_WINDOWS_HANDLING
}
...
function set_beef_config() {
	...
	{
	echo -e "beef:"
	echo -e "    version: 'getAir2U integrated'"
	echo -e "    debug: false"
...
#Rewrite getAir2U script in a polymorphic way adding custom beef location to array to get persistence
...
function iptables_nftables_detection() {
	...
	if ! "${getAir2U_FORCE_IPTABLES:-false}"; then
...
function set_script_paths() {
	...
	plugins_paths=(
					...
					"${user_homedir}.getAir2U/${plugins_dir}"
				)
}
...
function update_options_config_file() {
	...
	case "${1}" in
		"getdata")
			readarray -t OPTION_VARS < <(grep "getAir2U_" "${rc_path}" 2> /dev/null)
		;;
		"writedata")
			local option_name
			local option_value
...
function check_root_permissions() {
	...
	if [ "${user}" = "root" ]; then
		if ! "${getAir2U_SILENT_CHECKS:-false}"; then
			echo
...
function env_vars_initialization() {
	...
	ordered_options_env_vars=(
									"getAir2U_AUTO_UPDATE" #0
									"getAir2U_SKIP_INTRO" #1
									"getAir2U_BASIC_COLORS" #2
									"getAir2U_EXTENDED_COLORS" #3
									"getAir2U_AUTO_CHANGE_LANGUAGE" #4
									"getAir2U_SILENT_CHECKS" #5
									"getAir2U_PRINT_HINTS" #6
									"getAir2U_5GHZ_ENABLED" #7
									"getAir2U_FORCE_IPTABLES" #8
									"getAir2U_MDK_VERSION" #9
									"getAir2U_PLUGINS_ENABLED" #10
									"getAir2U_DEVELOPMENT_MODE" #11
									"getAir2U_DEBUG_MODE" #12
									"getAir2U_WINDOWS_HANDLING" #13
									)
...
#Detect if getAir2U is working inside a docker container
...
function initialize_extended_colorized_output() {
	...
	colorize=""
	if "${getAir2U_BASIC_COLORS:-true}" && "${getAir2U_EXTENDED_COLORS:-true}"; then
		if hash ccze 2> /dev/null; then
			colorize="| ccze -A"
		fi
	fi
...
#Kill tmux session started by getAir2U
...
#Starting point of getAir2U script inside newly created tmux session
function start_getAir2U_from_tmux() {
...
#Create new tmux session exclusively for getAir2U
function create_tmux_session() {
	...
	if [ "${2}" = "true" ]; then
		...
		start_getAir2U_from_tmux "normal"
	else
		tmux new-session -d -s "${1}"
		start_getAir2U_from_tmux "nested"
	fi
}
...
#shellcheck disable=SC2009
function close_existing_getAir2U_tmux_session() {

	debug_print

	if ! check_inside_tmux; then
		eval "kill -9 $(ps --no-headers aux | grep -i 'tmux.*getAir2U' | awk '{print $2}' | tr '\n' ' ') > /dev/null 2>&1"
	fi
}
...
function transfer_to_tmux() {
	...
	close_existing_getAir2U_tmux_session
...
function validate_plugin_requirements() {
	...
	if [ -n "${plugin_minimum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${plugin_minimum_ag_affected_version}" "${getAir2U_version}"; then
			return 1
		fi
	fi

	if [ -n "${plugin_maximum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${getAir2U_version}" "${plugin_maximum_ag_affected_version}"; then
			return 1
		fi
	fi
...
#Check for access to getAir2U repository
...
function autoupdate_check() {
	...
	if check_repository_access; then
		...
		getAir2U_last_version=$(timeout -s SIGTERM 15 curl -L ${urlscript_directlink} 2> /dev/null | grep "getAir2U_version=" | head -n 1 | cut -d "\"" -f 2)

		if [ -n "${getAir2U_last_version}" ]; then
			version_checked=1
		else
			http_proxy_detect
			if [ "${http_proxy_set}" -eq 1 ]; then

				getAir2U_last_version=$(timeout -s SIGTERM 15 curl --proxy "${http_proxy}" -L ${urlscript_directlink} 2> /dev/null | grep "getAir2U_version=" | head -n 1 | cut -d "\"" -f 2)
				if [ -n "${getAir2U_last_version}" ]; then
					version_checked=1
				else
					language_strings "${language}" 5 "yellow"
		...
		if [ "${version_checked}" -eq 1 ]; then
			if compare_floats_greater_than "${getAir2U_last_version}" "${getAir2U_version}"; then
...
function main() {
	...
	if ! "${getAir2U_DEVELOPMENT_MODE:-false}"; then
		if ! "${getAir2U_SKIP_INTRO:-false}"; then
			language_strings "${language}" 86 "title"
